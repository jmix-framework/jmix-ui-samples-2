...
@ViewController(id = "calendar-business-hours")
@ViewDescriptor(path = "calendar-business-hours.xml")
public class CalendarBusinessHoursSample extends StandardView {
    ...
    public void onInit(final InitEvent event) {
        declarativeCalendar.addDataProvider(new ListCalendarDataProvider(List.of(
    ...
    private void setBusinessHoursProgrammatically() {
        calendar.setBusinessHours(List.of(
                CalendarBusinessHours.of(
                        LocalTime.of(10, 0),
                        LocalTime.of(19, 0),
                        DayOfWeek.TUESDAY),
                CalendarBusinessHours.of(LocalTime.of(11, 0),
                        LocalTime.of(20, 0),
                        DayOfWeek.THURSDAY)));
    }
}