...
@ViewController(id = "calendar-select-allow-function")
@ViewDescriptor(path = "calendar-select-allow-function.xml")
public class CalendarSelectAllowFunctionSample extends StandardView {
    ...
    protected String convertToStrDate(LocalDate date) {
