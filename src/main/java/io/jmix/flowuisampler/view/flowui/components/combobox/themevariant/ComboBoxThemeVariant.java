...
public class ComboBoxThemeVariant extends StandardView {
    ...
    @ViewComponent
    protected JmixComboBox<CustomerGrade> alignCenterComboBox;
    @ViewComponent
    protected JmixComboBox<CustomerGrade> alignRightComboBox;
    ...
    protected void onInit(InitEvent event) {
        alignLeftComboBox.setValue(CustomerGrade.HIGH);
        alignCenterComboBox.setValue(CustomerGrade.STANDARD);
        alignRightComboBox.setValue(CustomerGrade.PREMIUM);
