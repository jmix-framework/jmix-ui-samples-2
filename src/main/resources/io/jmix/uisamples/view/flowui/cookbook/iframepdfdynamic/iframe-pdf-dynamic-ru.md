...
Динамические ресурсы загружаются на клиентскую часть с помощью специальных обработчиков `DownloadHandler`.

`DownloadHandler` генерирует уникальные URI . Регистрация URI ресурса автоматически обрабатывается компонентами, которые явно
